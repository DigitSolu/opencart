...
class ModelCatalogInformation extends Model {
	...
	public function getTotalInformations() {
		...
		return $query->row['total'];
			...
			public function QuickStatus($information_id, $data) {
			...
			public function MultiQuickStatus($information_id, $data) {
				$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "information WHERE information_id = '" . (int)$information_id . "'");
				if ($query->row['status'] == $data['status']){
					$this->db->query("UPDATE " . DB_PREFIX . "information SET status = '".$data['status']."' WHERE information_id = '" . (int)$information_id . "'");
				} else{
					$this->db->query("UPDATE " . DB_PREFIX . "information SET status = '".$data['status']."' WHERE information_id = '" . (int)$information_id . "'");
				}
				return $query->row;
