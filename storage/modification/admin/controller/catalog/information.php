...
class ControllerCatalogInformation extends Controller {
	...
	protected function getList() {
		...
		$data['sort_title'] = $this->url->link('catalog/information', 'user_token=' . $this->session->data['user_token'] . '&sort=id.title' . $url, true);
				...
				$data['sort_status'] = $this->url->link('catalog/information', 'user_token=' . $this->session->data['user_token'] . '&sort=status' . $url, true);
		...
		return !$this->error;
            ...
            public function quickStatus() {
				...
				if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
					...
					$this->model_catalog_information->QuickStatus($this->request->get['information_id']);
			...
			public function Multiplestatus() {
				...
				if (isset($this->request->post['selected'])) {
					foreach ($this->request->post['selected'] as $information_id) {
						$this->model_catalog_information->MultiQuickStatus($information_id, $this->request->post);
					}
