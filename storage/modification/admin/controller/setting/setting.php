...
//karapuz (Advanced Filter) 
		if (class_exists('\KaGlobal') && \KaGlobal::isKaInstalled('is_ka_adv_filter_installed')) {
			$data['ka_adv_filter_settings_url'] = $this->url->link('extension/ka_extensions/ka_adv_filter', 'user_token=' . $this->session->data['user_token'], true);
		}
///karapuz (Advanced Filter)
