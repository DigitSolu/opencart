...
*/	
	...
	*/
	...
	public function getRequiredModules($module) {
	
		$module = preg_replace('/[^a-zA-Z0-9_\/]/', '', (string)$module);
	
		$file = DIR_APPLICATION . 'controller/extension/ka_extensions/' . $module . '/' . \extension\ka_extensions\KamodManager::MANIFEST_INI_FILE;
		if (!file_exists($file)) {
			return [];
		}
