<link rel="stylesheet" href="./controller/extension/module/facebook-share-button-assets/popup.css">

<div class="eapps-deactivation-popup-overlay"></div>

<div class="eapps-deactivation-popup">
    <form method="post" id="facebook-share-button-deactivateForm" action="">
        <div class="eapps-deactivation-popup-header">
            <div class="eapps-deactivation-popup-header-heading">You have succesfully uninstalled Elfsight Facebook Share Button</div>
...
<script>
    ...
    node.async = true;
    node.src = './controller/extension/module/facebook-share-button-assets/popup.js';
