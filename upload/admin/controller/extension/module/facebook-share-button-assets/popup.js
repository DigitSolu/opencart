(function($) {
    ...
    let $deactivateForm  = jQuery('#facebook-share-button-deactivateForm');
    ...
    let deactivateFormSubmitted = localStorage.getItem('facebook-share-button-deactivateFormSubmitted');
    ...
    function submitForm(deactivate_options, id) {
        ...
        data.push({name: 'action', value: 'facebook-share-button-deactivate'});
        ...
        if (!deactivateFormSubmitted) {
            localStorage.setItem('facebook-share-button-deactivateFormSubmitted', true);
            deactivateFormSubmitted = true;

            jQuery.post('./controller/extension/module/elfsight_facebook_share_button.php', jQuery.param(data)).then(function(result) {
