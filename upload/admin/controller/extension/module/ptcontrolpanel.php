...
class ControllerExtensionModulePtcontrolpanel extends Controller
{
    ...
    public function index() {
        ...
        $data['database'] = array(
            DIR_APPLICATION . '../plazadata/plaza_db1.sql' => 'Layout Medical 1',
            DIR_APPLICATION . '../plazadata/plaza_db2.sql' => 'Layout Medical 2',
            DIR_APPLICATION . '../plazadata/plaza_db3.sql' => 'Layout Medical 3',
            DIR_APPLICATION . '../plazadata/plaza_db4.sql' => 'Layout Medical 4'
        );
