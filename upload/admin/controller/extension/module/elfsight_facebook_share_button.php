...
class Deactivate {
    ...
    public function __construct($data) {
        ...
        $this->app_slug = 'facebook-share-button';
        $this->app_name = 'Facebook Share Button';
    ...
    public function setDeactivateReasons() {
        return require ( (__DIR__) . '/facebook-share-button-assets/reasons.php' );
    }
...
class ControllerExtensionModuleElfsightFacebookShareButton extends Controller {
    private $error = array();

    public $params = NULL;

    const ELFSIGHT_EMBED_URL = 'https://apps.elfsight.com/embed/facebook-share-button/?utm_source=portals&utm_medium=opencart&utm_campaign=facebook-share-button&utm_content=sign-up';

    public function index() {
        $this->load->language('extension/module/elfsight_facebook_share_button');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            $this->model_setting_setting->editSetting('module_elfsight_facebook_share_button', $this->request->post);
        ...
        $data['action'] = $this->url->link('extension/module/elfsight_facebook_share_button', 'user_token=' . $this->session->data['user_token'], true);

        $data['cancel'] = $this->url->link('marketplace/extension', 'user_token=' . $this->session->data['user_token'] . '&type=module', true);

        if (isset($this->request->post['module_facebook_share_button_status'])) {
            $data['module_facebook_share_button_status'] = $this->request->post['module_facebook_share_button_status'];
        } else {
            $data['module_facebook_share_button_status'] = $this->config->get('module_facebook_share_button_status');
        }

        $data['header'] = $this->load->controller('common/header');
        $data['column_left'] = $this->load->controller('common/column_left');

        $this->response->setOutput($this->load->view('extension/module/elfsight_facebook_share_button', $data));
    }

    protected function validate() {
        if (!$this->user->hasPermission('modify', 'extension/module/elfsight_facebook_share_button')) {
    ...
    public function setDeactivateReasons() {
        return require ( './controller/extension/module/facebook-share-button-assets/reasons.php' );
    }
    ...
    public function uninstall() {
        ...
        include './controller/extension/module/facebook-share-button-assets/popup.php';
    }
    ...
    public function sendRequest($type) {
        ...
        $data['app_name'] = 'FacebookShareButton';
