    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-page" class="form-horizontal">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <div class="input-group">
                <input type="text" name="module_ciformbuilder_key" value="<?php echo $module_ciformbuilder_key; ?>" class="form-control" />
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body text-center">
          ...
          <br>
          <h5><a target="_blank" href="https://www.opencart.com/index.php?route=marketplace/extension/info&extension_id=30495" class="btn btn-primary"><i class="fa fa-link"></i> Purchase Form Builder Pro - Multi Form Creator</a></h5>
        </div>
      </div>
    </form>
  </div>
